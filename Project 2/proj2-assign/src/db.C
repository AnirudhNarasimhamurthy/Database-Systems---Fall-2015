...
Status DB::allocate_page(PageId& start_page_num, int run_size_int)
{
    ...
    //cout<<"Coming into db.C" << run_size_int <<"\n";
...
#endif
        //cout <<"Third Status is :" << status <<"\n";
        //cout <<"Return value is :" << set_bits( start_page_num, run_size, 1 ) <<"\n";
